...
Latest local verification on `codex/full-version-foundation` after the semantic motif routing, playable motif scene, coherence unlock, and authored procedural scene ontology pass:
