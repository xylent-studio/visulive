...
export function buildEmptyCaptureReportMarkdown(options = {}) {
  ...
  return [
    ...
    '- Collect a fresh Proof Mission batch into the inbox, then rerun analysis.',
    '',
    '## Next steps',
    '- Restart the live loop if needed.',
    '- Launch with `npm run dev:proof`, select a Proof Mission, and avoid manual/custom steering during serious proof.',
